...
const ANIMALS = {
    snail: {
        ...
        thinkingMessages: [
            ...
            'Einatmen... ausatmen... Stein werfen?',
            'Mein Haus ist mein Schloss, mein Zug ist mein Gesetz!',
            'Schleimiger Angriff in Zeitlupe!',
            'Wer hat gesagt, dass Spiele schnell sein müssen?',
            'Ich genieße den Ausblick von hier oben...',
            'Fast da... fast da... ZUG!',
            'Strategie braucht Weile!',
            'Ich bin nicht langsam, ich bin gründlich!',
            'Hoppla, bin ich eingeschlafen? Ach nein, ich denke!',
            'Diese Spalte sieht gemütlich aus...',
            'Kann ich meinen Stein auch kleben?',
            'Eile mit Weile, Sieg mit Schleim!'
        ],
    ...
    turtle: {
        ...
        thinkingMessages: [
            ...
            'Mein Urururgroßvater kannte diesen Zug...',
            'Langsam aber tödlich (strategisch gesehen)!',
            'Während du hechelst, plane ich den Sieg...',
            'Ein Panzer ist auch ein Pokerface...',
            'Salatblatt? Später! Jetzt Strategie!',
            'Die Jugend von heute ist so ungeduldig...',
            'Ich bin der Fels in der Brandung des Spiels!',
            'Stein für Stein baue ich meinen Sieg...',
            'Keine Hektik, nur Perfektion!',
            'Gähn... aber ein taktisches Gähnen!',
            'Wir sehen uns im Ziel... als Gewinner!'
        ],
    ...
    rabbit: {
        ...
        thinkingMessages: [
            ...
            'Zick-Zack-Kurs zum Sieg!',
            'Meine Nase wackelt im Takt der Strategie!',
            'Hopser hier, Hopser da... Gewonnen?!',
            'Ich bin schneller als mein Schatten... beim Denken!',
            'Wer hoppelt, gewinnt!',
            'Ein Haken, zwei Haken... Matt!',
            'Ist das ein Loch? Nein, eine Spalte!',
            'Auf die Plätze, fertig, HOPP!',
            'Meister Lampe hat eine Idee!',
            'Löffel hoch für den Sieg!',
            'Energiebündel sucht Zielspalte!'
        ],
    ...
    cat: {
        ...
        thinkingMessages: [
            ...
            'Macht einen Buckel... Taktik-Modus!',
            'Schubst den Stein vom Tisch... im Geist!',
            'Wenn ich gewinne, kriege ich Thunfisch?',
            'Augenschlitz-Modus aktiviert!',
            'Schnurrhaare orten Schwachstelle...',
            'Ich bin der König des Dschungels... äh, Spielbretts!',
            'Pfote drauf! Das ist mein Zug!',
            'Samtpfote, Eisenfaust (metaphorisch)!',
            'Spielzeug? Beute? SIEG!',
            'Lässt den Schwanz peitschen... Achtung!',
            'Mau... ich bin einfach perfekt!'
        ],
    ...
    fox: {
        ...
        thinkingMessages: [
            ...
            'Schlau wie ein... na, wie ich eben!',
            'Ich kenne den Weg durch den Hühnerstall(Spiel)!',
            'Tarnen und Täuschen...',
            'Dein Gesicht verrät deine Angst!',
            'Ich lache mir ins Fäustchen...',
            'Ein Meister der Täuschung am Werk!',
            'Roter Blitz, schlauer Zug!',
            'Hast du das gesehen? Nein? Gut!',
            'Ich schleiche mich an den Sieg heran...',
            'Meine List ist grenzenlos!',
            'Oh, ein Fehler deinerseits? Danke!'
        ],
    ...
    wolf: {
        ...
        thinkingMessages: [
            ...
            'Zähne fletschen... äh, lächeln!',
            'Der Winter naht... und mein Sieg auch!',
            'Ich bin der Leitwolf dieses Spiels!',
            'Spurenlesen im Gitter...',
            'Ich rieche deine Angst!',
            'Wild und unberechenbar... und genial!',
            'Ein einsamer Wolf? Nein, ein Sieger!',
            'Das Geheul des Triumphes bereitet sich vor...',
            'Lauf, kleine Beute, lauf!',
            'Die Nacht verbirgt meinen Zug...',
            'Kein Entkommen aus meinem Revier!',
            'Scharfe Zähne, scharfer Verstand!'
        ],
    ...
    owl: {
        ...
        thinkingMessages: [
            ...
            'Ich höre deine Gedanken (fast)!',
            'Lautlos wie mein Flug ist mein Sieg!',
            'Ein weises Orakel sieht 4 gewinnt!',
            'Federn sträuben... Intensität steigt!',
            'Aus dem Dunkeln ins Licht des Sieges!',
            'Meine Krallen greifen nach dem Erfolg!',
            'Weitblick ist meine Stärke!',
            'Ich sitze auf dem höchsten Ast der Strategie!',
            'Keine Maus entkommt, kein Stein entkommt!',
    ...
    dragon: {
        ...
        thinkingMessages: [
            ...
            'Mein Gold? Dieser Sieg hier!',
            'Ich atme Feuer... und Genialität!',
            'Ein Flügelschlag und das Blatt wendet sich!',
            'Welcher Ritter wagt es diesmal?',
            'Schuppenpanzer gegen Anfängerglück!',
            'Ich bin das Ende des Levels!',
            'Magie? Nein, reine Drachenkraft!',
            'Zittere vor dem Drachenodem!',
            'Höhlenbewohner mit Elite-Abschluss!',
            'Ich spiele schon seit dem Mittelalter...',
            'Deine Niederlage wird legendär sein!'
        ],
